...
static int32_t init_env() {
  ...
  //   printf("failed to DROP topic topicname, reason:%s\n", taos_errstr(pRes));
  //   return -1;
  // }
...
int main(int argc, char* argv[]) {
  ...
  // tmq_list_destroy(topic_list);//丢弃 list

  printf("begin consume loop\n");

  basic_consume_loop(tmq);// 开始消费
